import type { LinkTabPropsType } from "@types";

export type SizeType = "25%" | "50%" | "75%" | "100%";
type TabType = LinkTabPropsType & { size: SizeType, src?: string };
...
export const tabs: TabType[] = [
  ...
  },
  {
    ...
    label: "Дети",
    size: "100%",
    src: "/public/assets/images/portraits/enfp-male-kid.png"
  },
  {
    to: "/",
    iconName: "square-3",
