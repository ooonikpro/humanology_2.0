...
<template>
    <img class="graph" src="/public/assets/images/intertype/graph/quasidentical.svg">
    <div class="text">
    ...
    <div class="pairs"> 
        ...
        <UiText>
          <span class="g-color--water">Новатор</span> доказывает <span class="g-color--water">Предпринимателю</span>, что понимание вопроса всегда стоит потраченного времени.
        </UiText>
        
        <UiText>
          <span class="g-color--water">Предприниматель</span> объясняет <span class="g-color--water">Новатору</span>, что идея без реализации — это лишь трата времени.
        </UiText>
      ...
      <div class="pair">
        ...
        <UiText>
          <span class="g-color--earth">Дипломат</span> объясняет <span class="g-color--earth">Хранитель</span>, что стоит отвечать за свои эмоции.
        </UiText>
        
        <UiText>
          <span class="g-color--earth">Хранитель</span> учит <span class="g-color--earth">Дипломатf</span> преодолевать зависимость от настроения ради дела.
        </UiText>
      ...
      <div class="pair">
        ...
        <UiText>
          <span class="g-color--fire">Энтузиаст</span> учит <span class="g-color--fire">Политика</span> удовольствие от жизни. 
        </UiText>
    
        <UiText>
          <span class="g-color--fire">Политик</span> показывает <span class="g-color--fire">Энтузиасту</span>, как окружить себя правильными и комфортными отношениями.
        </UiText>
      ...
      <div class="pair">
        ...
        <UiText>
          <span class="g-color--air">Аналитик</span> показывает <span class="g-color--air">Критику</span>, как реализовывать свои возможности.
        </UiText>
    
        <UiText>
          <span class="g-color--air">Критик</span> учит <span class="g-color--air">Аналитика</span> доводить дела до результата.
        </UiText>
      ...
      <div class="pair">
        ...
        <UiText>
          <span class="g-color--water">Наставник</span> объясняет <span class="g-color--water">Советчик</span> исторический ход и его взаимодействие с событиями повседневности.
        </UiText>
      ...
      <div class="pair">
        ...
        <UiText> 
          <span class="g-color--fire">Лидер</span> учит <span class="g-color--fire">Администратора</span> размышлениям о причинах и последствиях в жизни.
        </UiText>
    
        <UiText>
          <span class="g-color--fire">Администратор</span> показывает <span class="g-color--fire">Лидеру</span>, ради чего стоит соблюдать правила.
        </UiText>
      ...
      <div class="pair">
        ...
        <UiText>
          <span class="g-color--air">Лирик</span> показывает <span class="g-color--air">Гуманисту</span> смысл позитивных эмоций.
        </UiText>
    
        <UiText>
          <span class="g-color--air">Гуманист</span> учит <span class="g-color--air">Лирика</span> получать позитивные эмоции от взаимодействия с людьми.
        </UiText>
