...
<template>
    <img class="graph" src="/public/assets/images/intertype/graph/supervisor.svg">
    <div class="text">
        ...
        <UiText>
            При этом, в глазах ревизора подревизный кажется человеком неплохим, но которому не хватает опыта. Подревизного хочется обучить, подсказать ему, как лучше делать.
        </UiText>

        <UiText>
            Но советы он не воспринимает и делает как прежде, что очень нервирует ревизора. Из-за этого ревизор может считать подревизного бестолковым человеком.
        </UiText>
        ...
        <UiText>
            Подревизные часто страдают тогда, когда ревизор — один из родителей или ближайших родственников. Из таких отношений подревизный партнер выходит часто с психологической травмой, неуверенностью в себе.
        </UiText>
        ...
        <UiText>
            Отношения ревизии — одни из самых неблагоприятных, наравне с конфликтными, поэтому при возможности, общение между партнëрами стоит сократить — это стресс, как и для ревизора, так и для подревизного.
        </UiText>
        ...
        <UiText color="dark-grey">
            Это касается любой информации, выдаваемой подревизному. Не стоит также требовать от него быстрого понимания. За любые положительные проявления со стороны подревизного стоит радоваться, за отрицательные — постараться не ругаться.
        </UiText>
