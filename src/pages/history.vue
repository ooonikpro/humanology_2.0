...
<template>
  <div class="page">
    ...
    <UiText color="accent">
      Мышление должно тщательно исключать чувство, если только оно желает быть настоящим, верным своему принципу мышлением.
    </UiText>

    <UiText color="accent">
      Но в таком случае речь идёт не о дифференцированном типе, а о сравнительно неразвитом мышлении и чувстве.
    </UiText>
    ...
    <UiText>
      Бриггс училась дома у своего отца. Утверждала, что она не помнит, кто научил её писать, но он или она сделали это плохо.
    </UiText>
    ...
    <UiText>
      Она создала для детей тест по призванию. Она видела в этом ключ к будущему счастью и благополучию ребенка.
    </UiText>
    ...
    <UiText color="accent">
      Эксперимент состоялся 1-3 августа 1987-го года. На эксперименте были проведены наблюдения за всеми 15-ю дихотомиями. В ситуации участвовала группа испытуемых около 25-и человек с определёнными типами. Все типы определяла сама Аушра. Многие из этих людей были её давнишними знакомыми.
    </UiText>
