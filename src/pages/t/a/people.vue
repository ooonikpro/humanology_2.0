...
<template>
  <div class="page">
    ...
    <UiText preset="subtitle" color="accent">
      Показывает связи между объектами. Отношения между людьми, симпатии, антипатии, любовь и ненависть — все это относится к этому аспекту.
    </UiText>
    ...
    <div class="sign-block">
      ...
      <UiText>
        Максимизация добра — этика прощения, притяжения.
      </UiText>
