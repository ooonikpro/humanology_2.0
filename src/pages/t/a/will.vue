...
<template>
  <div class="page">
    ...
    <div class="sign-block">
      ...
      <UiText>
        Максимизация силы — поддержание баланса; стремление к сильному, ищущая союзника, обороняющаяся.
      </UiText>
    ...
    <div class="sign-block">
      ...
      <UiText>
        Минимизация слабости — противоборствующая сила, конфронтационная, нападающая, угрожающая.
      </UiText>
