...
<template>
  <div class="page">
    ...
    <UiText preset="large" color="accent">
      Каждая функция работает с определенным аспектом жизни. Всего существует восемь соционических функций.
    </UiText>
    ...
    <UiText color="accent">
        Лучше рассматривать функции вместе с пониманием блоков, колец, мерностей и признаков.
      </UiText>
